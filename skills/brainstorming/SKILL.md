...
5. **Write design doc** — save to `docs/plans/000-<topic>-design.md` and commit
  - The number in front is incremental and for ordering - use 000 for the first design, then 001, etc
6. **Plan review loop** — dispatch plan-document-reviewer subagent with model gpt-5.4 and xhigh thinking effort with precisely crafted review context (never your session history); fix issues and re-dispatch until approved (max 3 iterations, then surface to human)
...
- Write the validated design (plan) to `docs/plans/000-<topic>-plan.md`
