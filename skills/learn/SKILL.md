---
name: learn
description: Update local AGENTS.md with strategic knowledge discovered during this session. Use when user says "learn", "save knowledge", "update AGENTS.md", "capture learnings", or at end of significant work sessions. Also used by commit skill for pre-commit knowledge capture.
...
## What Qualifies for Local AGENTS.md
...
### 1. Check Existing Local AGENTS.md
...
- Don't duplicate existing local or global AGENTS.md content
